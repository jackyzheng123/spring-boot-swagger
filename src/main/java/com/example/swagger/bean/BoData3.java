...
public class BoData3 implements Serializable {
    ...
    public BoData3 setStatus(boolean status) {
        this.status = status;
        if (status) {
            this.error = "";
        }
    ...
    public BoData3 setError(String error) {
        this.error = error;
    ...
    public BoData3 setErrorCode(int errorCode) {
